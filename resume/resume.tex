...
\begin{onehalfspacing}
\begin{itemize}
  \item MongoDB 持久层对接 DFV
  \item MongoDB 网络层对接 RoCE
\end{itemize}
\end{onehalfspacing}

\datedsubsection{\textbf{参与实现 FusionStorage Persistence Layer 保电内存缓存方案}}{2019年2月 -- 2019年9月}
\textit{C/Cache/Chunk}
\begin{onehalfspacing}
\begin{itemize}
...
\datedsubsection{\textbf{业务微服务化及CI/CD流程的制定}}{2016年7月 -- 2018年3月}
